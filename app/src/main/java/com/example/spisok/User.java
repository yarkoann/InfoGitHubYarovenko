...
public class User {
    ...
    private String orginazions_url;
    ...
    public String getOrginazions_url() {
        return orginazions_url;
    }

    public void setOrginazions_url(String orginazions_url) {
        this.orginazions_url = orginazions_url;
    }
